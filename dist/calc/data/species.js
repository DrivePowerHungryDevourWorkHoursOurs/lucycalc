...
var RBY = {
    ...
    Alakazam: {
        types: ['Psychic'],
        bs: { hp: 255, at: 50, df: 45, sl: 135, sp: 120 },
        weightkg: 48
    },
    Arbok: {
        types: ['Poison'],
    ...
    Venusaur: {
        types: ['Grass', 'Poison'],
        bs: { hp: 95, at: 70, df: 80, sl: 105, sp: 85 },
        weightkg: 100
    },
    Victreebel: {
        types: ['Grass', 'Poison'],
...
var ADV_PATCH = {
    ...
    Delcatty: {
        types: ['Normal'],
        bs: { hp: 90, at: 65, df: 65, sa: 55, sd: 55, sp: 70 },
        weightkg: 32.6,
...
var XY_PATCH = {
    ...
    Unfezant: { bs: { at: 115 } },
    Venusaur: { otherFormes: ['Venusaur-Mega', 'G-Venusaur'] },
    Victreebel: { bs: { sd: 70 } },
    Vileplume: { bs: { sa: 110 } },
